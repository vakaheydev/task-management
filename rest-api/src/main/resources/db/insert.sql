...
VALUES ('aka', '$2a$10$LlvbV5ZNIzNrZLv4YEEx0OzK7cFF6RRCGvgIGm66FEYkXWObGgpSi', 'Анна', 'Новгородова', 'Андреевна', 1),
       ('notifier', '$2a$10$oJCfShOgbDmf4nH6jJ8s9uT/ispBpMNC/VOENI04BiPxNFr1GZEme', 'notifier', 'notifier', 'notifier', 5),
       ('telegram', '$2a$10$OT54y3cbnlqS10tuZZPkD.AGKDnH4Rq.Hbe58RfnlIERsO/xnRBr2', 'telegram', 'telegram', 'telegram', 6);
